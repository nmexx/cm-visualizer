...
/**
 * Parse a European-formatted float string ("3,98" → 3.98).
 * @param {string} str
 * @returns {number}
 */
 ...
 * Fields are semicolon-delimited and are never quoted, so a simple split is safe.
 * @param {string} line
 * @returns {string[]}
 */
...
module.exports = { parseFloat_eu, parseDescriptionItem, parseCSVLine, sanitizeDate };
